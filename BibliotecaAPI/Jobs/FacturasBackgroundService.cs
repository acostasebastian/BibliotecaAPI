    ...
    public class FacturasBackgroundService : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            catch (OperationCanceledException)
            {
                ...
                //Aqui podemos ejecutar un código personalizado al detener la ejecución del job
            }            
        }
        ...
        private async Task EmitirFacturas(ApplicationDbContext context)
        {
                ...
                if (!facturasDelMesYaFueronEmitidas)
                {
                    ...
                    await context.Database.ExecuteSqlAsync($"EXEC Facturas_Crear {fechaInicio}, {fechaFin}");
                }            
